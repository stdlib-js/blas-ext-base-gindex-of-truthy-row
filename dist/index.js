...
var T=require('@stdlib/ndarray-base-assert-is-row-major-string/dist'),E=require('@stdlib/blas-base-assert-is-layout/dist'),F=require('@stdlib/math-base-special-fast-max/dist'),w=require('@stdlib/error-tools-fmtprodmsg/dist'),V=y();function P(a,r,t,f,n){var v,i,u;if(!E(a))throw new TypeError(w('nullFx',a));if(T(a)?(u=t,v=n,i=1):(u=r,v=1,i=n),n<F(1,u))throw new RangeError(w('nullIR',u,n));return V(r,t,f,v,i,0)}x.exports=P
